    ...
    public partial class UpdateDeleteBehavior : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAnswers", x => new { x.UserId, x.QuizId, x.QuestionId, x.AnswerId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserAnswers_UserQuizzes_UserId_QuizId",
                        columns: x => new { x.UserId, x.QuizId },
                        principalTable: "UserQuizzes",
                        principalColumns: new[] { "UserId", "QuizId" },
                        onDelete: ReferentialAction.Restrict);
                });
